import { AdventOfCodeChallenge, determineDataFileName, readEntriesFromDataFile  } from "./lib/AdventOfCodeChallenge";
...
const dayModule = await import(modulePath) as {
    part1 : AdventOfCodeChallenge,
    part2 : AdventOfCodeChallenge
};
...
const processedLines = await readEntriesFromDataFile(dataFilePath);
